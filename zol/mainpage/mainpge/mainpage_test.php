...
?>
 	<div class="quick-mark" >
		<i class="quick-mark-close"></i>
		<a href="http://www.zol.com.cn/help/index.html" class="quick-mark-pic" >
			<img class="tmp-style" src="http://icon.zol-img.com.cn/cms/zollogo/mqrcode.png" alt="中关村在线手机站" width="92" height="150">
		</a>
	</div>
<?php 
}
...
<?php 
if($guessConfigArr['template']=='baidu' || true){
?>
<!-- 百度推荐 -->
		<div id="hm_t_23453" style="display:none;"> 
